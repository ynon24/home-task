...
if [ "$EXTERNAL_IP" = "pending" ] || [ -z "$EXTERNAL_IP" ]; then
    ...
    echo "📋 Run this to get the IP when ready:"
    echo "   kubectl get services -n traefik"
    echo ""
    echo "🌐 Once ready, your services will be available at:"
    echo "   Service A (Bitcoin Rate): http://<EXTERNAL-IP>/service-a"
    echo "   Service B: http://<EXTERNAL-IP>/service-b"
else
    echo "🌐 Your services are available at:"
    echo "   Service A (Bitcoin Rate): http://$EXTERNAL_IP/service-a"
